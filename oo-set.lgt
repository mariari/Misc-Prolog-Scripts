...
%% Note on Unions: if the mem is directly from the second slot, it won't find the simplest solution first due to DFS. We could switch to BFS, since that's more useful for sets. 
  %% test(unions_bfs) :-
